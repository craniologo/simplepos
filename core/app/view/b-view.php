						...
						<div class="box-body table-responsive">
							<table class="table table-bordered datatable table-hover	">
								<thead>
									...
									<th style="text-align: center; width: 30px;">Venta</th>
								...
								<tr>
									...
									<td style="text-align: center;"><a href="./index.php?view=sell_one&id=<?php echo $sell->id; ?>" class="btn btn-primary btn-xs"><i class="fa fa-arrow-right"></i> <?php echo $sell->ref_id; ?></a></td>
									<td style="text-align: right;"><b><?php $operations = OperationData::getAllProductsBySellId($sell->id); $total_total += $sell->total-$sell->discount;
