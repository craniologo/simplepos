<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
    	<h2><?php echo $pro->name; ?> [Agregar]</h2>
      <a href="index.php?view=inventary" class="btn btn-default"><i class="fa fa-arrow-left"></i> Regresar</a>
    	<br>
  		<form class="form-horizontal" method="post" id="processadd" action="./?action=processadd" role="form">
        <div class="form-group">
          ...
          <div class="col-md-4">
            <textarea type="text" name="justify" required class="form-control" id="justify" required placeholder="Justificación para agregar"></textarea>
          </div>
        </div>
